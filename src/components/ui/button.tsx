  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        // Professional Legal Variants
        professional: "bg-gradient-primary text-primary-foreground hover:shadow-glow transition-all duration-300",
        accent: "bg-gradient-accent hover:bg-accent/90 text-accent-foreground font-semibold shadow-medium",
        ...
        record: "bg-destructive text-destructive-foreground hover:bg-destructive/90 shadow-glow animate-pulse",
      },
      size: {
